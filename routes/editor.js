...
router.get('/:id/standard/education/', (req, res) => {
    ...
    const expExists = current_resume ? (current_resume.education && current_resume.education.length > 0) : false;
    if (!expExists) {
...
router.get('/:id/standard/finalize/', (req, res) => {
    ...
    fs.readFile(path.join(__dirname, '../', 'views', 'server_side_templates', 'standard_server.mustache'), (err, data) => {
        ...
        const objTemplate = {type: 'standard', current_resume: current_resume, isFancy: true, activeRoute: 'finalize', isFinalize: true, cvId: id, resumes: html_entities.encode(JSON.stringify(req.session.resumes)), routes: routes, trackRoutes: trackRoutes,
        experience: routes.indexOf('experience')===-1 ? false : true, education: routes.indexOf('education')===-1 ? false : true, skills: routes.indexOf('skills')===-1 ? false : true, languages: routes.indexOf('languages')===-1 ? false : true, profile: routes.indexOf('profile')===-1 ? false : true};
        const output = Mustache.render(data.toString(), objTemplate);
        res.setHeader("Content-Type", "text/html");
        res.send(output);
...
router.get(['/:id/fancy/', '/:id/fancy/personal/'], (req, res) => {
    ...
    fs.readFile(path.join(__dirname, '../', 'views', 'newcv', 'editor2.mustache'), (err, data) => {
        ...
        const objTemplate = {type: 'fancy', current_resume: current_resume, isFancy: true, activeRoute: 'personal', isPersonal: true, cvId: id, resumes: html_entities.encode(JSON.stringify(req.session.resumes)), routes: routes, trackRoutes: trackRoutes,
...
router.get('/:id/fancy/experience/', (req, res) => {
    ...
    fs.readFile(path.join(__dirname, '../', 'views', 'server_side_templates', 'fancy_server.mustache'), (err, data) => {
        ...
        const objTemplate = {type: 'fancy', current_resume: current_resume, isList: true,isFancy: true, months: months, years: years, activeRoute: 'experience', isExperience: true, isCreate: false, cvId: id, resumes: html_entities.encode(JSON.stringify(req.session.resumes)), routes: routes, trackRoutes: trackRoutes,
                                experience: routes.indexOf('experience')===-1 ? false : true, education: routes.indexOf('education')===-1 ? false : true, certifications: routes.indexOf('certifications')===-1 ? false : true, skills: routes.indexOf('skills')===-1 ? false : true, socialLinks: routes.indexOf('socialLinks')===-1 ? false : true, portfolio: routes.indexOf('portfolio')===-1 ? false : true};
        const output = Mustache.render(data.toString(), objTemplate);
        res.setHeader("Content-Type", "text/html");
        res.send(output);
...
router.get('/:id/fancy/experience/create/', (req, res) => {
    ...
    fs.readFile(path.join(__dirname, '../', 'views', 'server_side_templates', 'fancy_server.mustache'), (err, data) => {
        ...
        const objTemplate = {type: 'fancy', current_resume: current_resume, isForm: true,isFancy: true, expExists: expExists,months: months, years: years, activeRoute: 'experience', isExperience: true, isCreate: true, cvId: id, resumes: html_entities.encode(JSON.stringify(req.session.resumes)), routes: routes, trackRoutes: trackRoutes,
                                experience: routes.indexOf('experience')===-1 ? false : true, education: routes.indexOf('education')===-1 ? false : true, certifications: routes.indexOf('certifications')===-1 ? false : true, skills: routes.indexOf('skills')===-1 ? false : true, socialLinks: routes.indexOf('socialLinks')===-1 ? false : true, portfolio: routes.indexOf('portfolio')===-1 ? false : true};
        const output = Mustache.render(data.toString(), objTemplate);
        res.setHeader("Content-Type", "text/html");
        res.send(output);
...
router.get('/:id/fancy/education/', (req, res) => {
    ...
    fs.readFile(path.join(__dirname, '../', 'views', 'server_side_templates', 'fancy_server.mustache'), (err, data) => {
        ...
        const objTemplate = {type: 'fancy', current_resume: current_resume, isList: true,isFancy: true, months: months, years: years, activeRoute: 'education', isEducation: true, isCreate: false, cvId: id, resumes: html_entities.encode(JSON.stringify(req.session.resumes)), routes: routes, trackRoutes: trackRoutes,
                                experience: routes.indexOf('experience')===-1 ? false : true, education: routes.indexOf('education')===-1 ? false : true, certifications: routes.indexOf('certifications')===-1 ? false : true, skills: routes.indexOf('skills')===-1 ? false : true, socialLinks: routes.indexOf('socialLinks')===-1 ? false : true, portfolio: routes.indexOf('portfolio')===-1 ? false : true};
        const output = Mustache.render(data.toString(), objTemplate);
        res.setHeader("Content-Type", "text/html");
        res.send(output);
...
router.get('/:id/fancy/education/create/', (req, res) => {
    ...
    fs.readFile(path.join(__dirname, '../', 'views', 'server_side_templates', 'fancy_server.mustache'), (err, data) => {
        ...
        const objTemplate = {type: 'fancy', current_resume: current_resume, isForm: true,isFancy: true, expExists: expExists,months: months, years: years, activeRoute: 'education', isEducation: true, isCreate: true, cvId: id, resumes: html_entities.encode(JSON.stringify(req.session.resumes)), routes: routes, trackRoutes: trackRoutes,
                                experience: routes.indexOf('experience')===-1 ? false : true, education: routes.indexOf('education')===-1 ? false : true, certifications: routes.indexOf('certifications')===-1 ? false : true, skills: routes.indexOf('skills')===-1 ? false : true, socialLinks: routes.indexOf('socialLinks')===-1 ? false : true, portfolio: routes.indexOf('portfolio')===-1 ? false : true};
        const output = Mustache.render(data.toString(), objTemplate);
        res.setHeader("Content-Type", "text/html");
        res.send(output);
...
router.get('/:id/fancy/certifications/', (req, res) => {
    ...
    fs.readFile(path.join(__dirname, '../', 'views', 'server_side_templates', 'fancy_server.mustache'), (err, data) => {
        ...
        const objTemplate = {type: 'fancy', current_resume: current_resume, isFancy: true, activeRoute: 'certifications', isCertifications: true, cvId: id, resumes: html_entities.encode(JSON.stringify(req.session.resumes)), routes: routes, trackRoutes: trackRoutes, certificationsArrayLength: certificationsArrayLength,
                                experience: routes.indexOf('experience')===-1 ? false : true, education: routes.indexOf('education')===-1 ? false : true, certifications: routes.indexOf('certifications')===-1 ? false : true, skills: routes.indexOf('skills')===-1 ? false : true, socialLinks: routes.indexOf('socialLinks')===-1 ? false : true, portfolio: routes.indexOf('portfolio')===-1 ? false : true};
        const output = Mustache.render(data.toString(), objTemplate);
        res.setHeader("Content-Type", "text/html");
        res.send(output);
...
router.get('/:id/fancy/skills/', (req, res) => {
    ...
    fs.readFile(path.join(__dirname, '../', 'views', 'server_side_templates', 'fancy_server.mustache'), (err, data) => {
        ...
        const objTemplate = {type: 'fancy', current_resume: current_resume, isFancy: true, activeRoute: 'skills', isSkills: true, cvId: id, resumes: html_entities.encode(JSON.stringify(req.session.resumes)), routes: routes, trackRoutes: trackRoutes, skillsArrayLength: skillsArrayLength,
                                experience: routes.indexOf('experience')===-1 ? false : true, education: routes.indexOf('education')===-1 ? false : true, certifications: routes.indexOf('certifications')===-1 ? false : true, skills: routes.indexOf('skills')===-1 ? false : true, socialLinks: routes.indexOf('socialLinks')===-1 ? false : true, portfolio: routes.indexOf('portfolio')===-1 ? false : true};
        const output = Mustache.render(data.toString(), objTemplate);
        res.setHeader("Content-Type", "text/html");
        res.send(output);
...
router.get('/:id/fancy/socialLinks/', (req, res) => {
    ...
    fs.readFile(path.join(__dirname, '../', 'views', 'server_side_templates', 'fancy_server.mustache'), (err, data) => {
        ...
        const objTemplate = {type: 'fancy', current_resume: current_resume, isFancy: true, activeRoute: 'socialLinks', isSocialLinks: true, cvId: id, resumes: html_entities.encode(JSON.stringify(req.session.resumes)), routes: routes, trackRoutes: trackRoutes,
                                experience: routes.indexOf('experience')===-1 ? false : true, education: routes.indexOf('education')===-1 ? false : true, certifications: routes.indexOf('certifications')===-1 ? false : true, skills: routes.indexOf('skills')===-1 ? false : true, socialLinks: routes.indexOf('socialLinks')===-1 ? false : true, portfolio: routes.indexOf('portfolio')===-1 ? false : true};
        const output = Mustache.render(data.toString(), objTemplate);
        res.setHeader("Content-Type", "text/html");
        res.send(output);
...
router.get('/:id/fancy/portfolio/', (req, res) => {
    ...
    fs.readFile(path.join(__dirname, '../', 'views', 'server_side_templates', 'fancy_server.mustache'), (err, data) => {
        ...
        const objTemplate = {type: 'fancy', current_resume: current_resume, isFancy: true, activeRoute: 'portfolio', isPortfolio: true, cvId: id, resumes: html_entities.encode(JSON.stringify(req.session.resumes)), routes: routes, trackRoutes: trackRoutes,
                                experience: routes.indexOf('experience')===-1 ? false : true, education: routes.indexOf('education')===-1 ? false : true, certifications: routes.indexOf('certifications')===-1 ? false : true, skills: routes.indexOf('skills')===-1 ? false : true, socialLinks: routes.indexOf('socialLinks')===-1 ? false : true, portfolio: routes.indexOf('portfolio')===-1 ? false : true};
        const output = Mustache.render(data.toString(), objTemplate);
        res.setHeader("Content-Type", "text/html");
        res.send(output);
...
router.get('/:id/fancy/finalize/', (req, res) => {
    ...
    fs.readFile(path.join(__dirname, '../', 'views', 'server_side_templates', 'fancy_server.mustache'), (err, data) => {
        ...
        const objTemplate = {type: 'fancy', current_resume: current_resume, isFancy: true, activeRoute: 'finalize', isFinalize: true, cvId: id, resumes: html_entities.encode(JSON.stringify(req.session.resumes)), routes: routes, trackRoutes: trackRoutes,
                                experience: routes.indexOf('experience')===-1 ? false : true, education: routes.indexOf('education')===-1 ? false : true, certifications: routes.indexOf('certifications')===-1 ? false : true, skills: routes.indexOf('skills')===-1 ? false : true, socialLinks: routes.indexOf('socialLinks')===-1 ? false : true, portfolio: routes.indexOf('portfolio')===-1 ? false : true};
        const output = Mustache.render(data.toString(), objTemplate);
        res.setHeader("Content-Type", "text/html");
        res.send(output);
